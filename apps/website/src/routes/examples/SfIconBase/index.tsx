...
import { SfIconPackage, SfIconSize } from 'qwik-storefront-ui';
...
export default component$(() => {
    ...
    examplesState.data = {
      controls: [
        ...
        },
        {
          ...
          modelName: 'color',
          description:
            '(not a prop) example showing possibility to change icons color',
  ...
  return (
    <ComponentExample>
      SfIconPackage imported from `qwik-storefront-ui`: <br />
