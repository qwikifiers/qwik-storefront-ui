...
import { SfAccordionItem, SfChip, SfIconChevronLeft } from 'qwik-storefront-ui';
...
export default component$(() => {
  ...
  const handleSizeSelection = $((val: string) => {
    selectedSizesSignal.value.indexOf(val) > -1
      ? (selectedSizesSignal.value = [
          ...selectedSizesSignal.value.filter((value) => value !== val),
        ])
      ...
      <div class="flex justify-between p-2 mb-2">
        ...
        <SfIconChevronLeft
          class={`text-neutral-500 ${
            openedSignal.value ? 'rotate-90' : '-rotate-90'
          }`}
        />
      </div>
      <div q:slot="detail">
